...
import { LogoutIcon, WarnIcon } from "../components/icons";
...
export default function Autenticacao() {
    ...
    async function submeter() {
        try {
            ...
            showErro(e?.message ??'Erro desconhecido');
        }
    }
    ...
    return (
        <div className={`bg-gray-100 flex  h-screen items-center justify-center `}>
            ...
            <div className={` w-full md:w-1/2 text-black m-10 lg:1/3 flex items-center justify-center`}>
                <div className="lg:w-96 md:w-4/5 ">
